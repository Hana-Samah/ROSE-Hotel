      ...
      <head>
         ...
         <style type="text/css">
            ...
            .form-group label {
               ...
               display: block; /* لضمان وضعية النص فوق الحقل */
               margin-bottom: 5px; /* مسافة بين النص والحقل */
            }

            .form-control {
               width: 100%; /* عرض الحقل بالكامل */
               padding: 8px; /* إضافة حشو داخلي للحقل */
               box-sizing: border-box; /* لضمان أن الحشو لا يؤثر على العرض الكامل */
            }
